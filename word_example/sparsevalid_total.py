...
class PercentileSparse(object):
    ...
    def get_mask(self):
        #prune.l1_unstructured(self.model.rnn, 'weight_hh_l0', amount = self.percentile)
        myparams = ((self.model.rnn, 'weight_hh_l0'),
                    (self.model.rnn, 'weight_ih_l0'),
                    (self.model.rnn, 'weight_hh_l1'),
                    (self.model.rnn, 'weight_ih_l1'),
                    (self.model.rnn, 'weight_hh_l2'),
